...
class YCB(openpifpaf.datasets.DataModule):
    _test_annotations = 'data/json/ycb_val.json'

    # TODO
    # cli configurable
    train_annotations = 'data/json/ycb_train.json'
    val_annotations = 'data/json/ycb_val.json'
    ...
    def __init__(self):
        ...
        cif = openpifpaf.headmeta.Cif('cif', 'ycb',
                                      keypoints=KEYPOINTS,
                                      sigmas=SIGMAS,
                                      pose=UPRIGHT_POSE,
                                      draw_skeleton=SKELETON)
        caf = openpifpaf.headmeta.Caf('caf', 'ycb',
                                      keypoints=KEYPOINTS,
                                      sigmas=SIGMAS,
                                      pose=UPRIGHT_POSE,
                                      skeleton=SKELETON)
    ...
    def cli(cls, parser: argparse.ArgumentParser):
        group = parser.add_argument_group('data module YCB')

        group.add_argument('--ycb-train-annotations',
                           default=cls.train_annotations)
        group.add_argument('--ycb-val-annotations',
                           default=cls.val_annotations)
        group.add_argument('--ycb-image-dir',
        ...
        group.add_argument('--ycb-upsample',
        ...
        eval_set_group.add_argument('--ycb-eval-test', default=False, action='store_true')

        group.add_argument('--ycb-long-edge', default=cls.eval_long_edge, type=int)
    ...
    def configure(cls, args: argparse.Namespace):
        ...
        # ycb specific
        cls.train_annotations = args.ycb_train_annotations
        cls.val_annotations = args.ycb_val_annotations
        cls.image_dir = args.ycb_image_dir
        ...
        cls.upsample_stride = args.ycb_upsample
        # cls.min_kp_anns = args.crowdpose_min_kp_anns

        # evaluation
        if args.ycb_eval_test:
            cls.eval_annotations = cls._test_annotations
        # cls.eval_long_edge = args.ycb_eval_long_edge
        # cls.eval_orientation_invariant = args.ycb_eval_orientation_invariant
        # cls.eval_extended_scale = args.ycb_eval_extended_scale
        # cls.eval_crowdpose_index = args.ycb_index
